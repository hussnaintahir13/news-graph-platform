/**
 * Builds Technical_Documentation_v1.0.docx for NewroSense (formerly NewroSense).
...
const cover = [
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 2400, after: 600 },
    children: [new TextRun({ text: "NewroSense", bold: true, size: 56 })] }),
...
const executive = [
  ...
  para("NewroSense is an open-source MVP that continuously crawls news, extracts the people, companies, countries and events mentioned in each article, and stores the resulting entity-relationship network in a graph-shaped database. The platform exposes the graph through an interactive Next.js front-end where users can:"),
...
const config = [
  ...
  gridTable(["Variable", "Default", "Purpose"], [
    ["DATABASE_URL", "`sqlite:///./newrosense.db`", "Engine URL"],
...
const licence = [
  h1("18. Licence"),
  para("NewroSense v1.0 is released under the MIT licence with an attribution rider:"),
  ...
  bullet("Retaining the attribution \"NewroSense — original work by Syed Hussnain Tahir Sherazi\" in derivative works, marketing material, and any public deployment of the software."),
...
const doc = new Document({
  ...
  title: "NewroSense — Technical Documentation",
  description: "NewroSense v1.0 — technical documentation",
    ...
    headers: {
      default: new Header({ children: [
        new Paragraph({ alignment: AlignmentType.RIGHT,
          children: [new TextRun({ text: "NewroSense — Technical Documentation v1.0", size: 18, color: "64748B" })] })
      ] })
    },
    footers: {
